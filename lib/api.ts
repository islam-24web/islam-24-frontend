  ...
  try {
    const res = await strapiFetch<StrapiResponse<Homepage>>({
      ...
      params: {
        ...
        "populate[sections][on][blocks.editor-pick][populate][articles][populate][featured_image]": "true",
        "populate[sections][on][blocks.editor-pick][populate][articles][populate][category]": "true",
        "populate[sections][on][blocks.youtube-embed]": "true",
        "populate[sections][on][blocks.audio-embed][populate][file]": "true",
        "populate[seo][populate]": "*",
      },
      tags: ["homepage"],
      revalidate: 300,
